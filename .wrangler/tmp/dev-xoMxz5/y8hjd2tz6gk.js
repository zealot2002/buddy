...
// .wrangler/tmp/pages-iSgYZA/functionsWorker-0.4526321927950303.mjs
  ...
  if (path.startsWith("/api/stories")) {
    if (method === "GET") {
      if (path === "/api/stories/nearby") {
        ...
        const nearbyStories = stories.map((story2) => ({
          ...story2,
          distance: Math.sqrt(
            Math.pow((story2.location.lat - lat) * 111, 2) + Math.pow((story2.location.lng - lng) * 111, 2)
          )
...
// .wrangler/tmp/pages-iSgYZA/y8hjd2tz6gk.js
...
// .wrangler/tmp/bundle-rgkytc/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-rgkytc/middleware-loader.entry.ts
